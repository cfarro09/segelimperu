							...
							<div class="card-body row">
								...
								<div id="div_fecha_nacimiento" class="mb-3 col-lg-6 col-xs-12">
									...
									<div class="input-group">
										<input required name="fecha_nacimiento" type="text" class="form-control input_detail datepicker-autoclose" placeholder="mm/dd/yyyy" data-date-format="yyyy-mm-dd">
			...
			<form id="form_hijos">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="mhijos_dni" class="control-label">Fecha DNI</label>
		...
		<div class="row">
			<div class="col-12">
				<div class="page-title-box">
					<h4 class="page-title float-left">Registrar Personal</h4>
					...
					<form id="form_generate_register" method="POST">
						<div id="crate_form" class="form-group col-md-12 col-sm-12 col-xs-12 row">
							...
							<div id="div_nrofile" class="col-lg-6 col-xs-12 mb-2">
								...
								<input required autocomplete="off" name="nrofile" type="text" class="input_detail form-control letrasnumeros" maxlength="10">
							</div>
							<div id="div_apellido_pat" class="col-lg-6 col-xs-12 mb-2">
								<label>Apellido Paterno</label>
								<input required autocomplete="off" name="apellido_pat" type="text" class="form-control sololetras input_detail" maxlength="100">
							</div>
							<div id="div_apellido_mat" class="col-lg-6 col-xs-12 mb-2">
								<label>Apellido Materno</label>
								<input required autocomplete="off" name="apellido_mat" type="text" class="form-control sololetras input_detail" maxlength="100">
							</div>
							<div id="div_nombres" class="col-lg-6 col-xs-12 mb-2">
								<label>Nombres</label>
								<input required autocomplete="off" name="nombres" type="text" class="input_detail form-control sololetras" maxlength="100">
							</div>
							<div id="div_tipodocumento" class="mb-2 col-lg-6 col-xs-12">
								<label>Tipo Documento</label>
								<select required class="form-control input_detail" name="tipodocumento">
							...
							<div id="div_nrodocumento" class="col-lg-6 col-xs-12 mb-2">
								...
								<input required autocomplete="off" name="nrodocumento" type="text" class="form-control letrasnumeros_especiales input_detail" maxlength="100">
							</div>
							<div id="div_tipocontrato" class="mb-2 col-lg-6 col-xs-12">
								<label>Tipo Contrato</label>
								<select required class="input_detail form-control" name="tipocontrato">
									<option value="" disabled selected>Seleccione</option>
							...
							<div id="div_observacion" class="col-lg-12 col-xs-12 mb-2">
								...
								<textarea required autocomplete="off" name="observacion" type="text" class="input_detail form-control" rows="5"></textarea>
							</div>
							<div id="div_fecha_ingreso" class="mb-3 col-lg-6 col-xs-12">
								<label>Fecha Ingreso</label>
								<div class="input-group">
									<input required autocomplete="off" name="fecha_ingreso" type="text" class="input_detail form-control datepicker-autoclose" placeholder="mm/dd/yyyy" data-date-format="yyyy-mm-dd">
									<div class="input-group-append"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
									</div>
								</div>
							</div>
							<div id="div_estado" class="mb-2 col-lg-6 col-xs-12">
								<label>estado</label>
								<select required class="input_detail form-control" name="estado">
									<option value="" disabled selected>Seleccione</option>
							...
							<div id="div_fecha_vencimiento" class="mb-3 col-lg-6 col-xs-12">
								...
								<div class="input-group">
									<input required autocomplete="off" name="fecha_vencimiento" type="text" class="input_detail form-control datepicker-autoclose" placeholder="mm/dd/yyyy" data-date-format="yyyy-mm-dd">
									<div class="input-group-append"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
									</div>
								</div>
							</div>
