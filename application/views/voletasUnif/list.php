...
<!-- <div id="modal_detail_voleta" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				<h4 class="modal-title">Detalle de voletas</h4>
			</div>
			...
			<div class="col-md-10 col-xs-12">
				<div class="card-box">
					...
					<table id="datatable" class="table" cellspacing="0" width="100%">
						...
						<tbody>
							<?php if ($list_voletas): ?>
								<?php foreach ($list_voletas as $vol): ?>
									<tr class="">
										<td class="nombres"><?= $vol->apellido_pat." ". $vol->nombres ?></td>
										<td class=""><?= $vol->dni ?></td>
										<td class=""><?= $vol->nro_voleta ?></td>
										<td class="text-center">
											<a href="<?= site_url() ?>VoletasUnif/edit_vol/<?= $vol->nro_voleta ?>" target="_blank">Ver</a>
											<a href="<?= site_url() ?>VoletasUnif/pdf_resumen/<?= $vol->dni ?>" class="pl-2 pr-2">Resumen</a>
										</td>
									</tr>
								<?php endforeach ?>
							<?php endif ?>
