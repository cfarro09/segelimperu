		...
		<div class="row">
			<div class="col-md-8 col-xs-12">
				<div class="card-box">
					...
					<form id="form_insert_voleta" method="POST">
						<div id="crate_form" class="form-group col-md-12 col-sm-12 col-xs-12 row">
							<div class="col-lg-12 col-xs-12 mb-2">
								...
								<!-- <input type="text" name="apellido_mat" id="apellido_mat" class="form-control" placheholder="Ingrese numero de voleta" required> -->
							</div>
							...
							<div class="col-lg-6 col-xs-12 mb-2">
								...
								<input type="number" name="dni" id="dni" class="form-control" placheholder="Ingrese numero de voleta" required readonly>
							</div>
							<div class="col-lg-6 col-xs-12 mb-2">
								<label for="">Apellido Paterno</label>
								<input type="text" name="apellido_pat" id="apellido_pat" class="form-control" placheholder="Ingrese numero de voleta" required readonly>
							</div>
							<div class="col-lg-6 col-xs-12 mb-2">
								<label for="">Apellido Materno</label>
								<input type="text" name="apellido_mat" id="apellido_mat" class="form-control" placheholder="Ingrese numero de voleta" required readonly>
							</div>
							<div class="col-lg-6 col-xs-12 mb-2">
								<label for="nombres">Nombres</label>
								<input type="text" name="nombres" id="nombres" class="form-control" placheholder="Ingrese numero de voleta" required readonly>
							</div>
							<div class="col-lg-6 col-xs-12 mb-2">
								<label for="">Nro° Boleta</label>
								<input type="number" name="nro_voleta" id="nro_voleta" class="form-control" placheholder="Ingrese numero de voleta" required>
							</div>
							<div class="col-lg-6 col-xs-12 mb-2">
								<label>Fecha</label>
...
<script>
	$(document).ready(function() {
		$("#select_tables").change(function() {
			...
			$.ajax({
				url: site_url + 'VoletasUnif/get_personal_data',
				data: {
					persona_id: $(this).val()
				},
				type: 'post',
